...
DOC
Help on module test_add:

NAME
    test_add - Тесты для функции сложения

CLASSES
    unittest.case.TestCase(builtins.object)
        TestAddFunction
    
    class TestAddFunction(unittest.case.TestCase)
     |  TestAddFunction(methodName='runTest')
     |  
     |  Тесты функции add()
     |  
     ...
     |  
     |  test_add_decimals(self)
     |      Сложение десятичных чисел
     |  
     |  test_add_large_numbers(self)
     |      Сложение больших чисел
     |  
     |  test_add_negative_numbers(self)
     ...
     |      Skip this test.
     |  
     |  subTest(self, msg=<object object at 0x7f05e1d88b50>, **params)
...
FILE
    /home/runner/work/KTLAb2/KTLAb2/test_add.py
