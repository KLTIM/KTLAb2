...
DOC
Help on module test_divide:

NAME
    test_divide - Тесты для функции деления

CLASSES
    unittest.case.TestCase(builtins.object)
        TestDivideFunction
    
    class TestDivideFunction(unittest.case.TestCase)
     |  TestDivideFunction(methodName='runTest')
     |  
     ...
     |  
     |  test_divide_by_one(self)
     |      Деление на единицу
     |  
     |  test_divide_decimals(self)
     |      Деление десятичных чисел
     |  
     |  test_divide_negative_numbers(self)
     |      Деление отрицательных чисел
     |  
     |  test_divide_positive_numbers(self)
     |      Деление положительных чисел
     |  
     |  test_divide_zero_by_number(self)
     ...
     |      Skip this test.
     |  
     |  subTest(self, msg=<object object at 0x7f151a588b50>, **params)
...
FILE
    /home/runner/work/KTLAb2/KTLAb2/test_divide.py
