...
DOC
Help on module test_subtract:

NAME
    test_subtract - Тесты для функции вычитания

CLASSES
    unittest.case.TestCase(builtins.object)
        TestSubtractFunction
    
    class TestSubtractFunction(unittest.case.TestCase)
     |  TestSubtractFunction(methodName='runTest')
     |  
     ...
     |  
     |  test_subtract_decimals(self)
     |      Вычитание десятичных чисел
     |  
     |  test_subtract_negative_numbers(self)
     |      Вычитание отрицательных чисел
     |  
     |  test_subtract_positive_numbers(self)
     |      Вычитание положительных чисел
     |  
     |  test_subtract_result_negative(self)
     |      Вычитание с отрицательным результатом
     |  
     |  test_subtract_zero(self)
     |      Вычитание с нулем
     |  
     |  ----------------------------------------------------------------------
     ...
     |      Skip this test.
     |  
     |  subTest(self, msg=<object object at 0x7f29ce4a0b50>, **params)
...
FILE
    /home/runner/work/KTLAb2/KTLAb2/test_subtract.py
