...
DOC
Help on module test_error_cases:

NAME
    test_error_cases - Тесты для обработки ошибок и edge cases

CLASSES
    unittest.case.TestCase(builtins.object)
        TestErrorCases
    
    class TestErrorCases(unittest.case.TestCase)
     |  TestErrorCases(methodName='runTest')
     |  
     ...
     |  
     |  test_divide_by_zero_error_message(self)
     |      Проверка сообщения об ошибке при делении на ноль
     |  
     |  test_divide_by_zero_raises_error(self)
     |      Деление на ноль вызывает исключение
     |  
     |  test_floating_point_precision(self)
     |      Тест точности вычислений с плавающей точкой
     |  
     |  test_large_numbers_operations(self)
     |      Операции с очень большими числами
     |  
     |  test_operation_chaining(self)
     ...
     |      Skip this test.
     |  
     |  subTest(self, msg=<object object at 0x7fa441930b50>, **params)
...
FILE
    /home/runner/work/KTLAb2/KTLAb2/test_error_cases.py
