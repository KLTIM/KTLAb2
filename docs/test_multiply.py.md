...
DOC
Help on module test_multiply:

NAME
    test_multiply - Тесты для функции умножения

CLASSES
    unittest.case.TestCase(builtins.object)
        TestMultiplyFunction
    
    class TestMultiplyFunction(unittest.case.TestCase)
     |  TestMultiplyFunction(methodName='runTest')
     |  
     ...
     |  
     |  test_multiply_by_one(self)
     |      Умножение на единицу
     |  
     |  test_multiply_by_zero(self)
     |      Умножение на ноль
     |  
     |  test_multiply_decimals(self)
     |      Умножение десятичных чисел
     |  
     |  test_multiply_negative_numbers(self)
     |      Умножение отрицательных чисел
     |  
     |  test_multiply_positive_numbers(self)
     ...
     |      Skip this test.
     |  
     |  subTest(self, msg=<object object at 0x7f5213ea0b50>, **params)
...
FILE
    /home/runner/work/KTLAb2/KTLAb2/test_multiply.py
